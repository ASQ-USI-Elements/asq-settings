...
module.exports = ASQPlugin.extend({
  ...
  updatePresentationSettingsDust: coroutine(function *updatePresentationSettingsDustGen(slideshow_id, settings, html){
  ...
  updateSlideshowSettings: coroutine(function *updateSlideshowSettings(option){
    ...
    var modifiedHtml = yield this.updatePresentationSettingsDust(option.slideshow_id, option.settings, option.html);
